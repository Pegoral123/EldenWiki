...
EXTERNAL_BOSSES_URL = "https://eldenring.fanapis.com/api/bosses"
...
def get_all_bosses():
    resposta = requests.get(EXTERNAL_BOSSES_URL)
    if resposta.status_code == 200:
        return resposta.json()
    return None


def get_limgrave_bosses():
    return limgrave_bosses


def get_caelid_bosses():
    return caelid_bosses